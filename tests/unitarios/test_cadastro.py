...
class FormularioPagarMe(unittest.TestCase):
    ...
    def test_deve_ter_ambiente(self):
        ...
        self.formulario.ambiente.opcoes.should.be.equal((('H', u'Homologação'), ('P', u'Produção')))

    def test_deve_ter_chave_api(self):
        self.formulario.chave_api.nome.should.be.equal('token')
        self.formulario.chave_api.ordem.should.be.equal(4)
    ...
    def test_deve_ter_chave_criptografica(self):
        ...
        self.formulario.chave_criptografia.ordem.should.be.equal(5)
    ...
    def test_deve_ter_usar_antifraude(self):
        self.formulario.usar_antifraude.nome.should.be.equal('usar_antifraude')
        self.formulario.usar_antifraude.ordem.should.be.equal(6)
        self.formulario.usar_antifraude.label.should.be.equal(u'Usar o serviço de Anti Fraude')
        self.formulario.usar_antifraude.tipo.should.be.equal(cadastro.cadastro.TipoDeCampo.boleano)

    def test_deve_ter_juros_valor(self):
        self.formulario.juros_valor.nome.should.be.equal('juros_valor')
        self.formulario.juros_valor.ordem.should.be.equal(7)
    ...
    def test_deve_ter_valor_minimo_aceitado(self):
        ...
        self.formulario.valor_minimo_aceitado.ordem.should.be.equal(8)
    ...
    def test_deve_ter_valor_minimo_parcela(self):
        ...
        self.formulario.valor_minimo_parcela.ordem.should.be.equal(9)
    ...
    def test_deve_ter_maximo_parcelas(self):
        ...
        self.formulario.maximo_parcelas.ordem.should.be.equal(11)
    ...
    def test_deve_ter_parcelas_sem_juros(self):
        ...
        self.formulario.parcelas_sem_juros.ordem.should.be.equal(12)
