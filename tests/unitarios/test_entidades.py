...
class RedeConfiguracaoMeioPagamento(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        super(RedeConfiguracaoMeioPagamento, self).__init__(*args, **kwargs)
    ...
    @mock.patch('pagador_pagarme.reloaded.entidades.ConfiguracaoMeioPagamento.preencher_gateway', autospec=True)
    ...
    def test_deve_definir_formulario_na_inicializacao(self, preencher_mock):
        configuracao = entidades.ConfiguracaoMeioPagamento(234)
        configuracao.formulario.should.be.a('pagador_pagarme.reloaded.cadastro.FormularioPagarMe')
